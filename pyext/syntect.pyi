...
class FontStyle:
    ...
    @staticmethod
    def from_string(value: str) -> Optional["FontStyle"]: ...
...
# ============================================================================
# Embedded bat/syntect-assets data
# ============================================================================

@dataclass
class Assets:
    """Embedded syntax/theme assets with configurable fallback lookup."""

    @staticmethod
    def from_binary() -> "Assets": ...
    def set_fallback_theme(self, name: str) -> None: ...
    def get_syntax_set(self) -> SyntaxSet: ...
    def get_theme(self, name: str) -> Theme: ...
    def get_theme_set(self) -> ThemeSet: ...
    def theme_names(self) -> List[str]: ...


@dataclass
class HighlightingAssets:
    """Alias for Assets matching syntect-assets naming."""

    @staticmethod
    def from_binary() -> "HighlightingAssets": ...
    def set_fallback_theme(self, name: str) -> None: ...
    def get_syntax_set(self) -> SyntaxSet: ...
    def get_theme(self, name: str) -> Theme: ...
    def get_theme_set(self) -> ThemeSet: ...
...
class SyntaxSet:
    ...
    def find_syntax_by_token(self, token: str) -> Optional[SyntaxReference]:
        """Find syntax by language token or alias."""
        ...

    def find_syntax_by_first_line(self, line: str) -> Optional[SyntaxReference]:
        """Find syntax by its first-line matcher."""
        ...
...
class ScopeSelectors:
    """Parsed TextMate scope selector set."""

    @staticmethod
    def from_string(value: str) -> "ScopeSelectors": ...
...
class ThemeSettings:
    ...
    selection: Optional[Color]
    gutter: Optional[Color]
...
class ThemeItem:
    ...
    scope: str
    scope_selectors: ScopeSelectors
    foreground: Optional[Color]
    background: Optional[Color]
    font_style: int
    ...
    def __init__(self, scope: ScopeSelectors, style: StyleModifier): ...
...
class ThemeSet:
    ...
    def add_from_folder(self, path: str) -> List[str]:
        """Load themes from folder and return loaded theme names."""
        ...

    @staticmethod
    def load_theme_from_reader(content: str) -> Theme: ...

    def add_theme(self, name: str, theme: Theme) -> None: ...
    def add_theme_from_reader(self, name: str, content: str) -> None: ...
    ...
    def get_theme(self, key: str, fallback: Optional[str] = None) -> Optional[Theme]:
        """Get theme by key, optionally resolving a fallback key."""
        ...
...
class HighlightLines:
    ...
    @staticmethod
    def with_theme(syntax_ref: SyntaxReference, syntax_set: SyntaxSet,
                   theme: Theme) -> "HighlightLines": ...
...
# ============================================================================
# Theme conversion and registry convenience
# ============================================================================

def is_vscode_theme(content: str) -> bool: ...
def is_plist_theme(content: str) -> bool: ...
def parse_vscode_theme(content: str) -> Theme: ...
def add_custom_theme(name: str, content: str) -> None: ...
def load_themes_from_folder(path: str) -> List[str]: ...
def list_themes() -> List[str]: ...
def get_theme(name: str) -> Optional[Theme]: ...
def get_theme_set() -> ThemeSet: ...
